const inputbox = document.querySelector(".countrySearch");
...
const renderCountry = (data, type = "country") => {
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">🏙️<span><i class="fas fa-2x fa-landmark"></i>${capital}</span></li>
    <li class="list-group-item">🧑‍🤝‍🧑<span><i class="fas fa-lg fa-users"></i>${(
      population / 1_000_000
    ).toFixed(2)} M</span></li>
    <li class="list-group-item">🗣️<span><i class="fas fa-lg fa-comments"></i>${Object.values(
      languages
    )}</span></li>
